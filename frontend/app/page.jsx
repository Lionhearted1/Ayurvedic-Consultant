  ...
  return (
    <>
      ...
      <div className="w-full h-full flex flex-col items-center content-between justify-center space-y-[3rem]" >
        ...
        <Link href='/login'><button className=" text-white text-[1rem] bg-green-800 bg-opacity-75 w-[auto] h-[auto]
        p-[0.5rem] rounded-lg  hover:bg-white hover:text-black md:text-[1.2rem] md:p-[1rem] lg:text-[1.4rem]">Get Started</button></Link>
      </div>
        </div>
    </>
  );
